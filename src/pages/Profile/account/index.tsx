                ...
                <div className="col-md-8 col-lg-8">
                    <div className="d-flex flex-column">
                        ...
                        <div className="d-flex flex-row text-white">
                            <div style={{background:"#FF3D1F"}} className="p-4 text-center skill-block">
                                <h4>{user.followers?.length || 0}</h4>
                                <h6>followers</h6>
                            </div>
                            <div style={{background:"#E01E00"}} className="p-3 text-center skill-block">
                                <h4>{user.following?.length || 0}</h4>
                                <h6>following</h6>
                            </div>
                            <div style={{background:"#A31600"}} className="p-3 text-center skill-block">
